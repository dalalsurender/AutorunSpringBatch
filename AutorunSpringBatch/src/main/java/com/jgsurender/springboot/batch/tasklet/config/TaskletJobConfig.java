package com.jgSurender.springboot.batch.tasklet.config;

import com.jgSurender.springboot.batch.tasklet.processor.FileProcessorStep;
import com.jgSurender.springboot.batch.tasklet.reader.FileReaderStep;
import com.jgSurender.springboot.batch.tasklet.writer.FileWriterStep;
 ...
 * File    : com.jgSurender.springboot.batch.tasklet.config.TaskletJobConfig
 * Date    : 15-08-2024
 * Version : 1.0
 **************************************/
@Configuration
