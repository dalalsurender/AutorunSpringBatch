package com.jgSurender.springboot.batch.fixedfile.config;

import com.jgSurender.springboot.batch.fixedfile.dto.InputDataDto;
import com.jgSurender.springboot.batch.fixedfile.dto.OutputDataDto;
import com.jgSurender.springboot.batch.fixedfile.processor.FixedFileItemProcessor;
import com.jgSurender.springboot.batch.fixedfile.reader.FixedFileItemReader;
import com.jgSurender.springboot.batch.fixedfile.writer.FixedFileItemWriter;
 ...
 * File    : com.jgSurender.springboot.batch.fixedfile.config.FixedFileBatchConfig
 * Date    : 01-11-2025
 * Version : 1.0
 **************************************/
@Configuration
