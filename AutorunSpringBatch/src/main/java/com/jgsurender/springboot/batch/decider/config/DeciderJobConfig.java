package com.jgSurender.springboot.batch.decider.config;

import com.jgSurender.springboot.batch.decider.step.NotifyQuiteStep;
import com.jgSurender.springboot.batch.decider.step.NotifyStep;
import com.jgSurender.springboot.batch.decider.condition.FlowDecider;
import com.jgSurender.springboot.batch.decider.processor.DeciderFileItemProcessor;
import com.jgSurender.springboot.batch.decider.reader.DeciderFileItemReader;
import com.jgSurender.springboot.batch.decider.writer.DeciderFileItemWriter;
 ...
 * File    : com.jgSurender.springboot.batch.dcider.config.DeciderJobConfig
 * Date    : 16-08-2024
 * Version : 1.0
 **************************************/
@Configuration
