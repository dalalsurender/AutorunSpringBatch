package com.jgSurender.springboot.batch.partition.config;

import com.jgSurender.springboot.batch.entity.EmpEntity;
import com.jgSurender.springboot.batch.partition.processor.PartitionFileItemProcessor;
import com.jgSurender.springboot.batch.partition.reader.PartitionFileItemReader;
import com.jgSurender.springboot.batch.partition.writer.PartitionFileItemWriter;
 ...
 * File    : com.jgSurender.springboot.batch.partition.config.PartitionJobConfig
 * Date    : 16-08-2024
 * Version : 1.0
 **************************************/
@Configuration
