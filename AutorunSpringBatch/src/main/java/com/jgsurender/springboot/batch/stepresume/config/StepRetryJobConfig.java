package com.jgSurender.springboot.batch.stepresume.config;

import com.jgSurender.springboot.batch.entity.EmpEntity;
import com.jgSurender.springboot.batch.stepresume.decider.StepExecutionDecider;
import com.jgSurender.springboot.batch.stepresume.step_1.processor.Step1FileItemProcessor;
import com.jgSurender.springboot.batch.stepresume.step_1.reader.Step1FileItemReader;
import com.jgSurender.springboot.batch.stepresume.step_1.writer.Step1FileItemWriter;
import com.jgSurender.springboot.batch.stepresume.step_2.processor.Step2FileItemProcessor;
import com.jgSurender.springboot.batch.stepresume.step_2.reader.Step2FileItemReader;
import com.jgSurender.springboot.batch.stepresume.step_2.writer.Step2FileItemWriter;
import com.jgSurender.springboot.batch.stepresume.step_3.processor.Step3FileItemProcessor;
import com.jgSurender.springboot.batch.stepresume.step_3.reader.Step3FileItemReader;
import com.jgSurender.springboot.batch.stepresume.step_3.writer.Step3FileItemWriter;
 ...
 * File    : com.jgSurender.springboot.batch.stepresume.config.StepRetryJobConfig
 * Date    : 17-08-2024
 * Version : 1.0
 **************************************/
@Configuration
